    ...
    <div className="space-y-16 max-w-[120rem] pt-20 pb-16">
      ...
      <div className="w-full flex justify-center">
        <div className="xl:columns-3 md:columns-2 columns-1 space-y-4">
          {Object.entries(personalProjects).map(([name, details], i) => (
      ...
      <div className="mx-auto text-center space-y-1">
        <h1 className="font-extrabold text-3xl text-neutral-700 dark:text-neutral-200">Career Projects</h1>
        <p className="text-lg font-medium">Preview of various career projects.</p>
      </div>

      <div className="w-full flex justify-center">
        <div className="xl:columns-3 md:columns-2 columns-1 space-y-4">
          {Object.entries(workProjects).map(([name, details], i) => (
            <BlurFade delay={0.25 * i * 0.1}>
              <ProjectPreview name={name} details={details} key={i} />
            </BlurFade>
          ))}
